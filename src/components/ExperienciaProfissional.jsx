...
import psicologaClinicaImg from '../assets/woman.svg';
import hospitalSaoLucasImg from '../assets/Telephone.svg';
  ...
  return (
    <section className="experiencia-profissional" id="experiencia-profissional">
      ...
      <div className="experiencia-item hospital-sao-lucas">
        ...
        <img src={hospitalSaoLucasImg} alt="Hospital São Lucas" className="icone-experiencia"/>
      </div>
      ...
      <div className="experiencia-item psicologa-clinica">
        ...
        <img src={psicologaClinicaImg} alt="Psicóloga Clínica" className="icone-experiencia"/>
      </div>
    </section>
  );
};
